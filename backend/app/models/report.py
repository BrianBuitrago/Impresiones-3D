...
class ReportItem(BaseModel):
    ...
    valor: float = Field(..., ge=0, description="Valor del ítem (precio de venta, no necesariamente lo ya cobrado)")
    rentabilidad: Optional[float] = Field(0.0, description="Ganancia real del ítem (venta - costos), a diferencia de 'valor' que es el precio de venta")

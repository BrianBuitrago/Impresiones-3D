...
class ProductoItem(BaseModel):
    ...
    tamanoHorizontal: Optional[float] = Field(0.0, ge=0, le=1000, description="Tamaño horizontal en cm (opcional)")
    tamanoVertical: Optional[float] = Field(0.0, ge=0, le=1000, description="Tamaño vertical en cm (opcional)")

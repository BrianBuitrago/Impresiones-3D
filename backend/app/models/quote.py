...
class ProductoItem(BaseModel):
    ...
    tamanoHorizontal: float = Field(..., gt=0, le=1000, description="Tamaño horizontal en cm")
    tamanoVertical: float = Field(..., gt=0, le=1000, description="Tamaño vertical en cm")

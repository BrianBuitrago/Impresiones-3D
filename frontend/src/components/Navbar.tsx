...
import { FOOTER_SETTINGS_ID, FOOTER_DEFAULTS, type FooterData } from "@/types/footer";
...
export default function Navbar() {
  ...
  const { data: footerData } = useEditableSetting<FooterData>(FOOTER_SETTINGS_ID, FOOTER_DEFAULTS);
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden md:flex items-center gap-2 pr-3 border-r border-slate-800">
              <a href={footerData.tiktokUrl} target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-cyan-400 transition-colors" title="TikTok">
              ...
              <a href={footerData.facebookUrl} target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-cyan-400 transition-colors" title="Facebook">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href={footerData.whatsappUrl} target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-cyan-400 transition-colors" title="WhatsApp">
            ...
            <button aria-label="Carrito de compras" className="text-slate-300 hover:text-cyan-400 transition-colors p-2 cursor-pointer">
